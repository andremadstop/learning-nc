  ...
  <div class="pbq-switch-config">
    ...
    <div v-if="activePort" class="pbq-port-editor">
      ...
      <div class="pbq-port-editor__actions">
        <button class="pbq-port-action pbq-port-action--secondary" @click="resetDraft" :disabled="disabled">Reset Port</button>
        <button class="pbq-port-action" @click="saveDraft" :disabled="disabled">Save Port</button>
      </div>
    </div>
  </div>
</template>
