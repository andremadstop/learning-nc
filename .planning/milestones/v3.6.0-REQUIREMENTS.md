# Requirements Archive: v3.6.0 Architect's Ascent
...
- [x] **SEC-01**: Sensible Telos-Felder (bio, telos_json) sind mit ICrypto verschluesselt gespeichert (nicht help_offer/help_wanted)
- [x] **SEC-02**: Jede Schwarm-Moderations-Entscheidung (approve/reject) wird mit User-ID, Timestamp und Aktion in audit_events protokolliert
