...
- [x] **SIM-01**: User kann in einer Kampagnen-Szene eine eingebettete Simulator-Challenge loesen (Firewall, DNS, Routing, NAT, PortScanner, Wireshark, AuthFlow)
- [x] **SIM-02**: Simulator-Ergebnis (bestanden/nicht bestanden, Score) wird an die Graph-Engine zurueckgemeldet und setzt pass_flag im State-Bag
...
|-------------|-------|--------|
| SIM-01 | Phase 80 | Complete |
| SIM-02 | Phase 80 | Complete |
