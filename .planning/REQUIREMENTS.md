...
- [x] **KI-02**: NPC-Portraits in DialoguePanel (CharacterAvatar + Sprechblase)
...
- [x] **KI-04**: Skill-Check UI mit Charakter-Reaktion (Erfolg/Misserfolg Animation)
...
| KI-02 | Phase 47 | Complete |
| KI-03 | Phase 47 | Complete |
| KI-04 | Phase 47 | Complete |
